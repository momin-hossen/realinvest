            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3 custom-reload-form" action="{{ route('register') }}" method="POST">
                            @csrf
                            ...
                            <button class="btn btn-primary ajax-btn d-grid w-100">Sign up</button>
                        </form>
