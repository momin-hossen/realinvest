                        ...
                        <tbody class="table-border-bottom-0">
                            @foreach ($tags as $tag)
                                <tr>
                                    ...
                                    <td>{{ $tag->title }}</td>
                                    <td>{{ $tag->slug }}</td>
                                    <td><span class="badge rounded-pill bg-label-{{ $tag->status ? 'primary':'danger' }}">{{ $tag->status ? 'Active':'Deactive' }}</span></td>
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item term-cat-modal" data-id="{{ $tag->id }}"
                                                    data-url="{{ route('admin.tags.update', $tag->id) }}"
                                                    data-title="{{ $tag->title }}" data-status="{{ $tag->status }}" href="javascript:void(0);">
    ...
    <div class="modal fade" id="create-term-modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <form action="{{ route('admin.tags.index') }}" method="post" class="custom-reload-form">
                    @csrf

                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel2">Create new tag</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" id="title" class="form-control" name="title" placeholder="Enter tag name" required>
                            </div>
                            <div class="col-12 mb-3">
